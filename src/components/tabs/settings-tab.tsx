    ...
    <div className="p-4 space-y-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex justify-between text-sm"><span className="text-muted-foreground">Next Service:</span><span className="font-medium text-accent">{new Date(roDevice.nextServiceDate).toLocaleDateString()}</span></div>
          <div className="flex justify-between text-sm"><span className="text-muted-foreground">Filter Life:</span><span className={`font-medium ${roDevice.filterLifeRemaining > 20 ? 'text-green-600' : 'text-destructive'}`}>{Math.round(roDevice.filterLifeRemaining)}% remaining</span></div>
      ...
      <Card>
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <div className="flex justify-between items-center">
              <span className="text-muted-foreground">Tap vs. Purified TDS:</span>
